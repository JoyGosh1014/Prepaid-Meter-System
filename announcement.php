...
if (isset($_GET['logout'])) {
    ...
    $filter = [];
$options = ['sort' => ['date_for' => -1]];
$result14 = $collection5->find($filter,$options);
    ...
    if($collection5->deleteOne(['_id' => new MongoDB\BSON\ObjectId("$id")])){
            ...
            foreach ($result14 as $data) {
                ...
                <div class="card mb-5">
                  ...
                  <div class="card-body">
                    ...
                    <button type="button" class="btn btn-danger"><a class="text-white" href="announcement.php?id=<?php echo $data['_id'] ;?>">Delete</a></button>
                  </div>
